...
#### [Download my DtrEnabled NintendoSpy release here for Atmel 32u4 Support.](https://github.com/ClydePowers/NintendoSpy-1/releases/tag/DTR)


#### [Download the latest official NintendoSpy release by jaburns here.](https://github.com/jaburns/NintendoSpy/releases/latest) (x64 and experimental x86 Windows binary)
